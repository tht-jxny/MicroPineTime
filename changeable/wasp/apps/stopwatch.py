...
class StopwatchApp():
    ...
    def _update(self):
        ...
        # now is of type time.struct_time(tm_year=2020, tm_mon=5, tm_mday=4, tm_hour=21, tm_min=25, tm_sec=29, tm_wday=0, tm_yday=125, tm_isdst=1)
        ...
        if self._last_count != self._count:
            ...
            draw.set_font(fonts.gotham36)
            w = fonts.width(fonts.gotham36, t1)
            draw.string(t1, 180-w, 120-36)
            draw.fill(0, 0, 120-36, 180-w, 56)

            draw.set_font(fonts.gotham24)
            draw.string(t2, 180, 120-18, width=46)
